local cfg = {
    meta = { name = "siemens_S7_400", description = "siemens_S7_400_plc", series = "400", manufacturer = "siemens" },
    inputs = {
    ...
    devs = {
        {sn = "1", name = "tunliu_plc_400", host = "192.168.3.25", rack=0, slot=0, tpl="tpl1"},
    }
}
