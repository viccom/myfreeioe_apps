...
_M['05']._encode = function(addr, fc, startnum, value)
    local pack_bin =
        string.pack('>I6', 0) ..
        string.pack('>I1', addr) .. string.pack('>I1', fc) .. string.pack('>I2', startnum) .. string.pack('>I2', value)
    return pack_bin
end
...
_M['06']._encode = function(addr, fc, startnum, value)
    ...
    local pack_bin =
        string.pack('>I6', 0) ..
        string.pack('>I1', addr) .. string.pack('>I1', fc) .. string.pack('>I2', startnum) .. valuebin
    return pack_bin
end
